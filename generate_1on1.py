...
# ─── 대상 원장 (입사·퇴사 시 이 줄만 수정) ─────────────
# 선주천 = 대표원장 본인. 연습용으로 본인 탭 운영. 진료 데이터는 없어 객관지표는 빈 차트.
VICE_DOCTORS = ["이문환", "방민준", "김한중", "선주천"]

DOC_COLORS = {
    "이문환": "#10b981",
    "방민준": "#f59e0b",
    "김한중": "#38bdf8",
    "선주천": "#a78bfa",         # 대표원장 본인 — 연습용 탭
    "선주천(예시)": "#c084fc",   # 6개월 가상 예시 데이터(VICE_DOCTORS에서 빠져 화면엔 안 보임)
    "_default": "#64748b",
}
